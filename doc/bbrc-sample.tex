...
database in order to obtain estimations of subgraph associations more precise than those 
obtained without sampling. The subgraph occurrence frequencies (support values) per class 
...
publicly available toxicological datasets.  An area of application are computational models of toxicology,
where subgraphs (fragments of chemical structure) are routinely used to describe
